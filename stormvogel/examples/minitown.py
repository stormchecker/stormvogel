...
def create_minitown_mdp():
    ...
    init.set_choices(
        {
            left: [(0.9, supermarket), (0.1, init)],
            right: [(0.9, square), (0.1, init)]
        }
    )
    supermarket.set_choices(
        {
            right: [(0.9, init), (0.1, square)]
        }
    )
    square.set_choices(
        {
            left: [(0.9, init), (0.1, square)],
            right: [(0.9, lib), (0.1, square)]
        }
    )
    lib.set_choices(
        {
            left: [(0.9, square), (0.1, lib)]
        }
    )
