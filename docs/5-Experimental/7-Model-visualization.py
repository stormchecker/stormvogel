...
# show(examples.create_car_mdp(), show_editor=True) # with layout editor
...
# %%
# show(examples.create_car_mdp(), show_editor=True
...
show(examples.create_car_mdp(), pos_function=positioning, pos_function_scaling=300)
...
# %%
show(examples.create_car_mdp(), engine="mpl")
